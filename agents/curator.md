...
3. For each stable cluster:
   ...
   b. Draft a new theme folder with all 9 files (manifest, rules, components, anti-patterns, motion, palette,
   typography, layout-grammar, copy-voice)
...
- The promoted theme is a PROPOSAL — a human (or the orchestrator in the next study phase) decides whether to accept it
  into `study/themes/`
